...
func (o *Options) GetFlagSet() *flag.FlagSet {
	...
	fs.BoolVar(&(o.consulLock), "consulLock", false, "Will read playbooks locally, but use Consul for locking.")
	fs.BoolVar(&(o.dropOutput), "dropOutput", false, "Will print all output from queries")
