...
* [Darwin (macOS)](https://github.com/snowplow/sql-runner/releases/download/0.10.1-rc1/sql_runner_0.10.1_rc1_darwin_amd64.zip)
* [Linux](https://github.com/snowplow/sql-runner/releases/download/0.10.1-rc1/sql_runner_0.10.1_rc1_linux_amd64.zip)
* [Windows](https://github.com/snowplow/sql-runner/releases/download/0.10.1-rc1/sql_runner_0.10.1_rc1_windows_amd64.zip)

### CLI Output

```bash
sql-runner version: 0.10.1-rc1
